...
<div class="col-12">
    <div class="card ">
        <div class="card-header">DEMANDE D'ENREGISTREMENT DES UTILISATEURS</div>
            <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-responsive-md table-striped text-center">
                    ...
                    @foreach ($users as $user)
                        <tr>
                            ...
                            <td>{{ $user->email}}</td>
                            <td>
                                <a href="{{ route('user.edit', $user->id) }}" role="button" class="btn btn-primary"><i class="fa fa-edit"></i></a>

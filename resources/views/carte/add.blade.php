...
<div class="row">
                ...
                <div class="card-body">
                    ...
                    <div class="col-lg-6  offset-lg-3">
                        <div class="form-group">
                            ...
                            <input type="text" id="dob_input" name="date_naiss"  value="{{ old('date_naiss') }}" class="form-control"required>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6  offset-lg-3">
                        <div class="form-group">
                            <label>Numero </label>
                            <input type="text" id="docNumber_input" name="numero"  value="{{ old('numero') }}" class="form-control"required>
                        </div>
                    </div>
                    <div>
                        <br>
    ...
    <div class="col-md-4">
        ...
        <fieldset id="authTypes" class="column is-6 has-background-light">
            ...
            <!--Password types-->
        <fieldset id="pwdTypes" class="column is-6 has-background-light">

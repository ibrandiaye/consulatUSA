                ...
                <li class="nav-item dropdown dropdown-authentication">
                    <a class="nav-link dropdown-toggle no-caret" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <span> @if(Auth::user()) {{Auth::user()->name}} @endif<i class="zmdi zmdi-chevron-down"></i></span>
                            </div>
                        </div>
                    </a>
                ...
                <div class="navbar-nav-wrap">
                    <ul class="navbar-nav flex-column">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="javascript:void(0);" data-toggle="collapse" data-target="#carte">
                                <span class="feather-icon"><i data-feather="credit-card"></i></span>
                                <span class="nav-link-text">Carte</span>
                            </a>
                            <ul id="carte" class="nav flex-column collapse collapse-level-1">
                                <li class="nav-item">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('carte.create') }}">Ajouter</a>
                                        </li>
                                        <li class="nav-item active">
                                            <a class="nav-link" href="{{ route('carte.index') }}">Liste</a>
                                        </li>
